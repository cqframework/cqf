...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.opencds.cqf&a=tooling&v=1.4.5-SNAPSHOT&c=jar-with-dependencies"
SET tooling_jar=tooling-1.4.5-SNAPSHOT-jar-with-dependencies.jar
